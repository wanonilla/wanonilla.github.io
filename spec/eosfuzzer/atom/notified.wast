(module
  ...
  (data (;1;) (i32.const 8256) "eosio.token\00")
  (data (;2;) (i32.const 8268) "end of notified::apply\00")
  (data (;3;) (i32.const 8291) "in notified::transfer - \00")
  (data (;4;) (i32.const 8316) "yes\00")
  (data (;5;) (i32.const 8320) "no\00")
  (data (;6;) (i32.const 8323) "magnitude of asset amount must be less than 2^62\00")
  (data (;7;) (i32.const 8372) "invalid symbol name\00")
  (data (;8;) (i32.const 8392) "read\00")
  (data (;9;) (i32.const 8397) "get\00")
  (data (;10;) (i32.const 16812) "malloc_from_freed was designed to only be called after _heap was completely allocated\00"))
