(module
  ...
  (import "env" "tapos_block_prefix" (func (;3;) (type 2)))
  (import "env" "__multi3" (func (;4;) (type 5)))
  (import "env" "send_inline" (func (;5;) (type 4)))
  (import "env" "memcpy" (func (;6;) (type 6)))
  (import "env" "abort" (func (;7;) (type 1)))
  ...
  (import "env" "__multf3" (func (;12;) (type 5)))
  (import "env" "__addtf3" (func (;13;) (type 5)))
  (import "env" "__subtf3" (func (;14;) (type 5)))
  ...
  (import "env" "__divtf3" (func (;22;) (type 5)))
  ...
  (import "env" "get_blockchain_parameters_packed" (func (;28;) (type 3)))
  (func (;29;) (type 1))
  ...
  (global (;1;) i32 (i32.const 16882))
  (global (;2;) i32 (i32.const 16882))
  ...
  (data (;1;) (i32.const 8204) "transfer\00")
  (data (;2;) (i32.const 8213) "divide by zero\00")
  (data (;3;) (i32.const 8228) "signed division overflow\00")
  (data (;4;) (i32.const 8253) "multiplication overflow\00")
  (data (;5;) (i32.const 8277) "multiplication underflow\00")
  (data (;6;) (i32.const 8302) "write\00")
  (data (;7;) (i32.const 8308) "magnitude of asset amount must be less than 2^62\00")
  (data (;8;) (i32.const 8357) "invalid symbol name\00")
  (data (;9;) (i32.const 8377) "read\00")
  (data (;10;) (i32.const 8382) "get\00")
  (data (;11;) (i32.const 16796) "malloc_from_freed was designed to only be called after _heap was completely allocated\00"))
