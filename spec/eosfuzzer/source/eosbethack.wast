(module
  ...
  (import "env" "require_recipient" (func (;7;) (type 8)))
  ...
  (func (;12;) (type 9) (param i32)
    ...
    i64.load offset=8
    call 6)
  (func (;13;) (type 10) (param i64 i64 i64)
    ...
    i32.add
    i32.store offset=4)
  (func (;14;) (type 0) (param i32 i64 i64 i32 i32)
    (local i32 i64 i64)
    block  ;; label = @1
      local.get 0
      i64.load
  ...
  (data (;10;) (i32.const 272) "eosbetdice11\00")
  (data (;11;) (i32.const 8688) "malloc_from_freed was designed to only be called after _heap was completely allocated\00"))
