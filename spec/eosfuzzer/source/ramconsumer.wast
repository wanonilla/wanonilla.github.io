(module
  ...
  (import "env" "db_find_i64" (func (;4;) (type 4)))
  (import "env" "db_get_i64" (func (;5;) (type 6)))
  (import "env" "db_store_i64" (func (;6;) (type 7)))
  (import "env" "eosio_assert" (func (;7;) (type 5)))
  (import "env" "memcpy" (func (;8;) (type 6)))
  (import "env" "read_action_data" (func (;9;) (type 8)))
  (import "env" "require_auth2" (func (;10;) (type 2)))
  (import "env" "tapos_block_num" (func (;11;) (type 3)))
  ...
  (func (;17;) (type 10) (param i64 i64 i64)
    ...
    i32.add
    i32.store offset=4)
  (func (;18;) (type 11) (param i32 i64 i64)
  ...
  (func (;19;) (type 9) (param i32)
    ...
    i32.add
    i32.store offset=4)
  (func (;20;) (type 12) (param i32 i64 i32)
    (local i32 i32 i64 i32 i32 i32 i64 i32 i32 i32 i32)
    i32.const 0
    i32.const 0
    i32.load offset=4
    i32.const 64
  ...
  (func (;21;) (type 8) (param i32 i32) (result i32)
    ...
    i32.store offset=4
    local.get 6)
  (func (;22;) (type 13) (param i32 i32 i64 i32)
  ...
  (func (;37;) (type 9) (param i32)
    call 0
    unreachable)
  (func (;38;) (type 6) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 5
    block  ;; label = @1
  ...
  (export "_ZeqRK11checksum256S1_" (func 12))
  (export "_ZeqRK11checksum160S1_" (func 13))
  (export "_ZneRK11checksum160S1_" (func 14))
  (export "now" (func 15))
  (export "_ZN5eosio12require_authERKNS_16permission_levelE" (func 16))
  (export "apply" (func 17))
  (export "malloc" (func 29))
  (export "free" (func 32))
  (export "memcmp" (func 38))
  (data (;0;) (i32.const 4) "\80b\00\00")
  ...
  (data (;6;) (i32.const 192) "error reading iterator\00")
  (data (;7;) (i32.const 224) "read\00")
  (data (;8;) (i32.const 240) "magnitude of asset amount must be less than 2^62\00")
  (data (;9;) (i32.const 304) "invalid symbol name\00")
  (data (;10;) (i32.const 336) "get\00")
  (data (;11;) (i32.const 8736) "malloc_from_freed was designed to only be called after _heap was completely allocated\00"))
