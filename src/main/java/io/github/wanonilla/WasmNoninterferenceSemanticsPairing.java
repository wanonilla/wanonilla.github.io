...
public class WasmNoninterferenceSemanticsPairing {
    private WasmNoninterferenceSemanticsPairing() {
    }
    ...
    public static List<String> getSemantics() {
        return List.of(
                ...
                "resource:///horst/pairing/predicates/states.horst",
                "resource:///horst/pairing/instructions/numeric.horst",
                "resource:///horst/pairing/instructions/parametric.horst",
                "resource:///horst/pairing/instructions/variable.horst",
                "resource:///horst/pairing/instructions/memory.horst",
                "resource:///horst/pairing/instructions/control.horst"
        );
    }
    ...
    public static List<String> getSemanticsForFunctionTests() {
        ...
        files.add("resource:///horst/pairing/instructions/imported-functions.horst");
        files.add("resource:///horst/pairing/testing/init.horst");
        files.add("resource:///horst/pairing/testing/propagation.horst");
        files.add("resource:///horst/pairing/testing/noninterference.horst");
//        files.add("resource:///horst/pairing/testing/reachability.horst");
